...
- [~] Remote: run and audit the 116-row LongBench v2 Full/V1 panel. The first terminal-backed job was interrupted after 103/116 complete sample pairs. Exact-prefix recovery archived the original artifacts, retained 206 generations and 618 complete timing rows, isolated four partial timing rows, and resumed from sample 104 in detached `screen` session `exp3_final`.
