...
- [~] Remote: run and audit the 116-row LongBench v2 Full/V1 panel. Sequential Full/V1 job started under PID 2729; metadata reached `running` and the first paired timing completed.
